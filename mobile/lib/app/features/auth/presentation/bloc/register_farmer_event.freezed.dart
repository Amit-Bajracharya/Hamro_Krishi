...
part of 'register_farmer_event.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RegisterFarmerEvent);
}
...
/// @nodoc
class $RegisterFarmerEventCopyWith<$Res>  {
$RegisterFarmerEventCopyWith(RegisterFarmerEvent _, $Res Function(RegisterFarmerEvent) __);
}


/// Adds pattern-matching-related methods to [RegisterFarmerEvent].
extension RegisterFarmerEventPatterns on RegisterFarmerEvent {
...
class RegisterSubmitted implements RegisterFarmerEvent {
...
/// Create a copy of RegisterFarmerEvent
...
@override
String toString() {
  return 'RegisterFarmerEvent.registerSubmitted(name: $name, email: $email, password: $password, phone: $phone, latitude: $latitude, longitude: $longitude)';
}
...
/// @nodoc
abstract mixin class $RegisterSubmittedCopyWith<$Res> implements $RegisterFarmerEventCopyWith<$Res> {
...
class TogglePasswordVisibility implements RegisterFarmerEvent {
