    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8.h),
          BlocBuilder<RegisterConsumerBloc, RegisterConsumerState>(
            ...
            builder: (context, state) {
              return _buildTextField(
                ...
                onIconTap: () {
                  context.read<RegisterConsumerBloc>().add(const RegisterConsumerEvent.togglePasswordVisibility());
                },
              );
            },
          ),
          ...
          child: ElevatedButton(
            onPressed: isLoading
                ...
                : () {
                    ...
                    context.read<RegisterConsumerBloc>().add(
                          RegisterConsumerEvent.registerSubmitted(
